...
Thus it appears that the improvement of campaign performance was a result 
of a new, optimized approach that exploited changing attitudes in a country 
in crisis, and that a similar improvement would not have been possible before. 
...
emphasizing security and wealth protection - although this is mere speculation.
...
In this report we will focus on one example: the number of people employed.

Looking at change over time may help to understand patterns.
The date is not given, but, according to the data set documentation,
...
smoothed and normalized so that they each integrate to 1.
...
Note the gradual increase of the frequency of "yes" responses
in much of the first half, followed by steep bump just before 
observation 30'000, and then a solid rise (the drop at the end
is an artifact of the plot). 
...
of the plot. Again, the lower bar at the end of the plot and consequently 
the apparent drop both of "yes" and "no" responses is an artifact of the 
plot. In fact, the share of "yes" responses rises to over 50% in the last 
bar.
