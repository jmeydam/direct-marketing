...
but at the time of this writing the author has not the slightest idea what 
conclusions have been reached by others. Consequently, this study may turn 
out to offer a fresh perspective, but it is more likely that it will 
merely rediscover what has already been described more clearly elsewhere.

# Executive Summary

observations are ordered by date, from May 2008 to November 2010.
...
"yes" responses, while present from the
...
on the data after. The model trained on the earlier data has nor predictive 
...
have been used for optimizing campaigns. Indeed, later campaigns
appear to have been informed by such a model, systematically targeting 
subgroups and calibrating the number of calls.

To conclude, it appears that the improvement of campaign performance
